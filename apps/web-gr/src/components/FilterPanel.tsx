...
const SORT_OPTIONS: { id: SortOption; label: string; hint?: string }[] = [
  { id: 'best_deal',     label: 'Καλύτερη προσφορά' },
  { id: 'most_relevant', label: 'Καλύτερη αντιστοίχιση', hint: 'Δεν λαμβάνεται υπόψη η τιμή' },
  { id: 'newest',        label: 'Νεότερα' },
  { id: 'cheapest',      label: 'Φθηνότερα' },
  { id: 'safest',        label: 'Πιο αξιόπιστα' },
];

const CONDITIONS: { id: Condition; label: string; emoji: string }[] = [
  { id: 'new',      label: 'Νέο',              emoji: '✨' },
  { id: 'like_new', label: 'Σαν καινούριο',    emoji: '⭐' },
  { id: 'good',     label: 'Καλή κατάσταση',   emoji: '👍' },
  { id: 'fair',     label: 'Μεταχειρισμένο',   emoji: '🔧' },
  { id: 'poor',     label: 'Κατεστραμμένο',    emoji: '⚠️' },
];
        ...
        <div className="mt-3 p-4 bg-white rounded-xl border border-slate-200 shadow-sm space-y-5">
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                type="text"
                placeholder="Πόλη ή περιοχή, π.χ. Αθήνα"
            ...
            <p className="text-xs text-slate-400 mt-1">Φιλτράρει αποτελέσματα με βάση την τοποθεσία της αγγελίας</p>
          </div>
          ...
          <div>
            ...
            {activeConditions.length === 0 && (
              <p className="text-xs text-slate-400 mt-1">Χωρίς επιλογή = εμφάνιση όλων</p>
            )}
          </div>
