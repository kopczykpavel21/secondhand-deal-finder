...
export const plMarket: MarketConfig = {
  ...
  sourceOptions: [
    ...
    { id: 'allegro_lokalnie', label: 'Allegro Lokalnie', badge: 'partial' },
  ...
  texts: {
    ...
    description: 'Porównujemy oferty z OLX, Allegro Lokalnie, Sprzedajemy.pl i Vinted i pokazujemy najlepsze okazje.',
    heroBadge: 'Beta · OLX · Allegro Lokalnie · Sprzedajemy.pl · Vinted',
    tagline: 'Porównujemy oferty z OLX, Allegro Lokalnie, Sprzedajemy.pl i Vinted i pokazujemy najlepsze okazje.',
    searchPlaceholder: 'Czego szukasz? Np. iPhone 13, rower, kurtka zimowa...',
    emptyStateTitle: 'Wpisz czego szukasz',
    emptyStateBody: 'Przeszukamy OLX, Allegro Lokalnie, Sprzedajemy.pl i Vinted jednocześnie.',
